inputs = {
  ...
  resource_group_name                   = "dlzdev02"          # The resource group all resources will be deployed to
  owner_tag                             = "Arkahna"               # Owner tag value for Azure resources
  environment_tag                       = "loc"                   # This is used on Azure tags as well as all resource names
