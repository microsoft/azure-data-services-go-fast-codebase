inputs = {
  ...
  resource_group_name                   = "sifmoq"          # The resource group all resources will be deployed to
  ...
  ip_address                            = "103.12.191.40"            # This is the ip address of the agent/current IP. Used to create firewall exemptions.
