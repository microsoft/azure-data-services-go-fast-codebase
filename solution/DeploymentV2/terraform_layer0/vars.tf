...
variable "vpn_subnet_cidr" {
  description = "CIDR of the subnet used for p2s vpn"
  type        = string
  default     = "10.0.0.64/27"
}
variable "vpn_gateway_address_range" {
  description = "Address Range for the p2s vpn"
  type        = string
...
variable "deploy_vpn" {
  description = "Feature toggle for deploying p2s vpn"
  default     = true
  type        = bool
}
...
variable "state_storage_account_name" {
  description = "The override name for the storage account used for storing state data. If empty, will be autogenerated."
  default     = ""
  type        = string
}
...
variable "vpn_gateway_name" {
  description = "The override name for the vpn gateway service. If empty, will be autogenerated based on prefix settings"
  default     = ""
  type        = string
}
...
variable "existing_vpn_subnet_id" {
  description = "An existing subnet id for reuse for the p2s vpn"
  default     = ""
  type        = string
}
