   ...
   "resources": [
      {
		...
		"name": "[concat(parameters('dataFactoryName'), '/', 'GPL_"+TargetType+"_"+TargetFormat+"_Post_Copy_', parameters('integrationRuntimeShortName'))]",
		"properties": {
			"activities": [
				{
						...
						"ifTrueActivities": [
							{
								...
								"userProperties": [],
								"typeProperties": Post_Copy_Lookup_PostCopySQL_TypeProperties(TargetType, TargetFormat)
							},
							{
						...
						"ifTrueActivities": [
							{
								...
								"userProperties": [],
								"typeProperties": Post_Copy_Lookup_MergeSQL_TypeProperties(TargetType, TargetFormat)
							},
							{
						...
						"ifTrueActivities": [
							{
								...
								"userProperties": [],
								"typeProperties": Post_Copy_Lookup_AutoMergeSQL_TypeProperties(TargetType, TargetFormat)
							},
							{
							...
							},
							{
								...
								"userProperties": [],
								"typeProperties":Post_Copy_Lookup_CreateStage_TypeProperties(TargetType, TargetFormat)
							},
							{
								...
								"userProperties": [],
								"typeProperties":Post_Copy_Lookup_CreateTarget_TypeProperties(TargetType, TargetFormat)
							},
							{
			...
			"folder": {
				"name": "[concat('ADS Go Fast/Data Movement/', parameters('integrationRuntimeName') ,'/Common')]"
			},
			"annotations": [],
