...
namespace SecureFileUploader.Data.Migrations
{
    ...
    [Migration("20220930052320_Timezones")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SecureFileUploader.Common.Model.AccessToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SecureFileUploader.Common.Model.Invitee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SecureFileUploader.Common.Model.InviteeEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SecureFileUploader.Common.Model.InviteeEventType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SecureFileUploader.Common.Model.Program", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("SecureFileUploader.Common.Model.ProgramEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SecureFileUploader.Common.Model.ProgramEventType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SecureFileUploader.Common.Model.ProgramSettingsSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SecureFileUploader.Common.Model.Settings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SecureFileUploader.Common.Model.AccessToken", b =>
                {
                    b.HasOne("SecureFileUploader.Common.Model.Invitee", "Invitee")
            ...
            modelBuilder.Entity("SecureFileUploader.Common.Model.Invitee", b =>
                {
                    b.HasOne("SecureFileUploader.Common.Model.Program", "Program")
                        .WithMany("Invitees")
            ...
            modelBuilder.Entity("SecureFileUploader.Common.Model.InviteeEvent", b =>
                {
                    b.HasOne("SecureFileUploader.Common.Model.InviteeEventType", "EventType")
            ...
            modelBuilder.Entity("SecureFileUploader.Common.Model.ProgramEvent", b =>
                {
                    b.HasOne("SecureFileUploader.Common.Model.ProgramEventType", "EventType")
                        .WithMany()
                        .HasForeignKey("EventTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SecureFileUploader.Common.Model.ProgramSettingsSnapshot", b =>
                {
                    ...
                    b.OwnsOne("SecureFileUploader.Common.Model.SettingsValues", "Settings", b1 =>
                        {
