...
namespace SecureFileUploader.Data.Migrations
{
    ...
    [Migration("20220912042010_AddSupportForNotificationService")]
    partial class AddSupportForNotificationService
    {
            ...
            modelBuilder.Entity("SecureFileUploader.Data.Models.Settings", b =>
                {
                    ...
                    b.Property<string>("InviteFromDisplayName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("InviteFromEmailAddress")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("InviteSendGridTemplateId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.OwnsOne("SecureFileUploader.Data.Models.SettingsValues", "Settings", b1 =>
                        {
                            ...
                            b1.Property<string>("InviteFromDisplayName")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("InviteFromEmailAddress")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)");

                            b1.Property<string>("InviteSendGridTemplateId")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)");
